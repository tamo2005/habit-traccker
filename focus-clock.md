...
The expanded timer shows a continuously updating local clock and four accessible presets: **Pomodoro** (25/5), **Short break** (5), **Long break** (15), and **Custom**. Local browser validation confirmed that selecting Long break updates the badge, switches to the break animation treatment, sets the interval to 15:00, and labels the primary action **Start break**. The full test suite now contains 19 passing assertions and the production build succeeds.
